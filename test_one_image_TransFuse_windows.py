...
def inference(model):
    ...
    for i, pack in enumerate(test_loader, start=1):
        ...
        res2, res3, res = model(image)
        res = F.upsample(res, size=(192, 256), mode='bilinear', align_corners=False)
...
if __name__ == '__main__':
    ...
    # modify allocation
    datasetname = 'kvasir82'
    datasetpath = r'D:\datasets\paper2_dataset\kvasir82\test'
    # kvasir82  ETIS-LaribPolypDB82  CVC_ClinicDB811  CVC-ColonDB811  ISIC2017  ISIC811  bowl  GLas  COVID
    modelpath = r"C:\Users\15059\Desktop\Paper2model\TransFuse\13_Kvasir.pth"
    # kvasir82  ETIS-LaribPolypDB82  CVC_ClinicDB811  CVC-ColonDB811  ISIC2017  ISIC811  bowl  GLas  COVID
    ...
    # from mmseg.models.segmentors import TransFuse_S as UNet
