...
class UNet(nn.Module):
    ...
    Args:
        in_channels (int): Number of input images channels. Default" 3.
    ...
    Notice:
        The input images size should be devisible by the whole downsample rate
    ...
    def _check_input_devisible(self, x):
        ...
        assert (h % whole_downsample_rate == 0) \
            ...
            f'The input images size {(h, w)} should be devisible by the whole '\
