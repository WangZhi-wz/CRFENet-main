...
class Decoder(nn.Module):
    ...
    def __init__(self, dims, dim, class_num=2):
        ...
        self.aff1_12 = iAFF(64)
        self.aff1_23 = iAFF(128)
        self.aff1_34 = iAFF(320)
        self.aff2_12 = iAFF(64)
        self.aff2_23 = iAFF(128)
        self.aff3_12 = iAFF(64)
    ...
    def forward(self, inputs):
        ...
        # upsampling c2
        c1_2 = self.upsample12(c2) # 1 64 88 88
        # SGFM11 c1 c2
        # c1_12 = self.sgfm1_12(c1, c1_2) # 1 64 88 88
        # AFF c1 c2
        c1_12 = self.aff1_12(c1, c1_2) # 1 64 88 88


        # upsampling c3
        c1_3 = self.upsample13(c3) # 1 128 44 44
        # SGFM12 c2 c3
        # c1_23 = self.sgfm1_23(c2, c1_3) # 1 128 44 44
        # AFF c2 c3
        c1_23 = self.aff1_23(c2, c1_3) # 1 128 44 44

        # upsampling c4
        c1_4 = self.upsample14(c4) # 1 320 22 22
        # SGFM13 c3 c4
        # c1_34 = self.sgfm1_34(c3, c1_4) # 1 320 22 22
        # AFF c3 c4
        c1_34 = self.aff1_34(c3, c1_4) # 1 320 22 22


        # upsampling c123
        c2_1 = self.upsample21(c1_23)
        # SGFM21 c112 c123
        # c2_12 = self.sgfm2_12(c1_12, c2_1)
        # AFF21 c112 c123
        c2_12 = self.aff2_12(c1_12, c2_1)
        # residual net
        # c2_12 = c2_12 + c1_2

        # upsampling c134
        c2_2 = self.upsample22(c1_34)
        # SGFM22 c123 c134
        # c2_23 = self.sgfm2_23(c1_23, c2_2)
        # AFF22 c123 c134
        c2_23 = self.aff2_23(c1_23, c2_2)
        # residual net
        # c2_23 = c2_23 + c1_3

        # upsampling c223
        c3_1 = self.upsample31(c2_23)
        # SGFM31 c212 c223
        # c3_12 = self.sgfm3_12(c2_12, c3_1)
        # AFF31 c212 c223
        c3_12 = self.aff3_12(c2_12, c3_1)
        # residual net
        # c3_12 = c3_12 + c1_23
...
class colonformer_ssformer_moddecoder_AFF(nn.Module):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(colonformer_ssformer_moddecoder_AFF, self).__init__()
