...
class Decoder(nn.Module):
    ...
    def __init__(self, dims, dim, class_num=2):
        ...
        self.convcc3 = Conv2d(256*2, 256, kernel_size=1)
        self.convcc2 = Conv2d(128*2, 128, kernel_size=1)
        self.convcc1 = Conv2d(64*2, 64, kernel_size=1)
...
class colonformer_ssformer_add(nn.Module):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(colonformer_ssformer_add, self).__init__()
        ...
        self.decode_head = Decoder(dims=[64, 128, 256, 512], dim=[64, 128, 256, 512], class_num=1)
