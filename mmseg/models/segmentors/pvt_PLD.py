...
class pvt_PLD(nn.Module):
    def __init__(self, class_num):
        super(pvt_PLD, self).__init__()
    ...
    def _init_weights(self):
        pretrained_dict = torch.load("./pretrained/pvt_small_iter_40000.pth")
...
class pvt_PLD_large_seg(nn.Module):
    def __init__(self, class_num):
        super(pvt_PLD_large_seg, self).__init__()
