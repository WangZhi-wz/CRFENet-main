...
#
#         self.linear_pred = nn.Conv2d(3 * embedding_dim, self.num_classes, 3, padding=1)
#
...
#
#         _c = self.linear_pred(torch.cat([_c3, _c2, _c1], dim=1))
#
#         return _c
# spec = {
# 'NUM_STAGES': 3,
...
# 'STRIDE_Q': [1, 1, 1],
# }
# class cvt_mla(nn.Module):
#     def __init__(self, class_num=1, **kwargs):
#         super(cvt_mla, self).__init__()
#         self.class_num = class_num
#         self.backbone = ConvolutionalVisionTransformer(spec = spec)
#         self.decode_head = Decoder(dims=[64, 192, 384], dim=128, class_num=class_num)
...
#         pretrained_dict = torch.load('/mnt/DATA-1/DATA-2/Feilong/scformer/models/cvt/CvT-21-384x384-IN-1k.pth')
...
#
#
# MitEncoder = cvt_mla(class_num=1)
