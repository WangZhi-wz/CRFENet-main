...
from mmseg.models.segmentors.networks_other import init_weights
...
class MultiAttentionBlock(nn.Module):
    ...
    def forward(self, input, gating_signal):
        # input 1 64 56 75  gating_signal 1 128 28 37
        gate_1, attention_1 = self.gate_block_1(input, gating_signal) # gate_1 1 64 56 75, attention_1 1 64 56 75
        gate_2, attention_2 = self.gate_block_2(input, gating_signal) # gate_1 1 64 56 75, attention_1 1 64 56 75
