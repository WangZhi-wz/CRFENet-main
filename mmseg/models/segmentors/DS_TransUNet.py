...
from mmseg.models.checkpoint import load_checkpoint
from mmseg.models.module import PreNorm, Attention, FeedForward
...
class UNett(nn.Module):
    def __init__(self, dim, n_class, in_ch=3):
        ...
        self.encoder.init_weights('pretrained/swin_base_patch4_window7_224_22k.pth')
        self.encoder2.init_weights('pretrained/swin_tiny_patch4_window7_224.pth')
