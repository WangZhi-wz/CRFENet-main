...
from mmseg.models.segmentors.UACANet.modules.layers import *
from mmseg.models.segmentors.UACANet.utils import *
...
class UACA(nn.Module):
    ...
    def forward(self, x, map):
        ...
        # compute class probability 计算类概率
        map = F.interpolate(map, size=x.shape[-2:], mode='bilinear', align_corners=False)
        fg = torch.sigmoid(map)
