...
from mmseg.models.segmentors.UNetdevice.layers import unetConv2, unetUp
from mmseg.models.segmentors.UNetdevice.utils_unet import init_weights, count_param
...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=2, is_deconv=True, is_batchnorm=True):
        ...
        self.conv1 = unetConv2(3, filters[0], self.is_batchnorm)
