...
class Decoder(nn.Module):
    ...
    def __init__(self, dims, dim, class_num=2):
        ...
        # self.iaff2 = iAFFmod(256)
        # self.iaff3 = iAFFmod(512)
        ...
        # self.dp4 = DP(1024, Norm2d)
        # self.dp3 = DP(512, Norm2d)
        # self.dp2 = DP(256, Norm2d)
...
class colonformer_ssformer_baseline0301_AFF_DP0505(nn.Module):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(colonformer_ssformer_baseline0301_AFF_DP0505, self).__init__()
