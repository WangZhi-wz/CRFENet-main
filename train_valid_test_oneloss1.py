...
def inference(model, args):
    ...
    X_test = glob('{}/images/*'.format(args.valid_path))
    X_test.sort()
    y_test = glob('{}/masks/*'.format(args.valid_path))
    y_test.sort()
    ...
    # out
    print("Valid Result: loss: {:0.4f}, dice={}, miou={}, precision={}, recall={} \n"
                .format(loss_record_test.show(), mean_dice, mean_iou, mean_precision, mean_recall))
    f = f"{save_path}result/train.txt"
    with open(f, "a") as filenametest:  # ”w"代表着每次运行都覆盖内容
        filenametest.write("\nValid Result: loss: {:0.4f}, dice={}, miou={}, precision={}, recall={} \n"
                .format(loss_record_test.show(), mean_dice, mean_iou, mean_precision, mean_recall))
    filenametest.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='./datakvasir811/TrainDataset', help='path to train dataset')
    parser.add_argument('--valid_path', type=str,
                        default='./datakvasir811/ValidDataset', help='path to dataset')
    parser.add_argument('--test_path', type=str,
                        default='./datakvasir811/TestDataset', help='path to dataset')
