...
def inference(model, args):
    ...
    with open(f, "a") as filenametest:  # 新的内容将会被写入到已有内容之后。如果该文件不存在，创建新文件进行写入
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_save', type=str,
                        default='ConlonFormerB2')   ######################################################保存模型训练数据修改文件夹路径
    ...
    parser.add_argument('--test_path', type=str,
                        default='./datatest/TestDataset', help='path to dataset')
