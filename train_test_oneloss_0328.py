    ...
    with torch.autograd.set_detect_anomaly(True):
        for i, pack in enumerate(train_loader, start=1):
            ...
            for rate in size_rates: 
                ...
                map3, map2 = model(images)
                loss = structure_loss(map3, gts) + structure_loss(map2, gts)
...
if __name__ == '__main__':
    ...
    # mod decoder 0328 F3Net+AFF
    from mmseg.models.segmentors import colonformer_ssformer_mod_0328 as UNet
