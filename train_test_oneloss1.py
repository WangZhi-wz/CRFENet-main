...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str,
                        default='CVC_ClinicDB811', help='path to dataset')
    ...
    # from mmseg.models.segmentors import colonformer_ssformer_method1 as UNet
    ...
    model = UNet(backbone=dict(
                ...
                pretrained='pretrained/mit_{}.pth'.format(args.backbone)
